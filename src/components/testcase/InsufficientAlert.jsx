...
const InsufficientAlert = ({ data }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 rounded-xl shadow-xl p-6 mb-8">
      <div className="flex items-start">
        ...
        <div className="ml-4 flex-1">
          ...
          <p className="text-red-700 mb-4">{data.notice}</p>
          
          {/* Coverage Badge */}
          {data.coverage_percentage !== undefined && (
            <div className="mb-4">
              <span className="inline-flex items-center px-4 py-2 bg-red-100 text-red-800 rounded-lg font-semibold text-sm">
              ...
              <ul className="space-y-2">
                {data.user_advice.map((advice, idx) => (
                  <li key={idx} className="flex items-start bg-orange-50 p-3 rounded-lg">
                    ...
                    <span className="text-orange-800">{advice}</span>
                  </li>
                ))}
              </ul>
            </div>
