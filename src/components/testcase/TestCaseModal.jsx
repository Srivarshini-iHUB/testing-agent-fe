      ...
      >
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-120px)] p-8 space-y-6">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200">
            <h4 className="text-sm font-bold text-blue-900 uppercase tracking-wide mb-2">Feature</h4>
            <p className="text-gray-800 text-lg font-semibold">{testCase.feature_name}</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
              <p className="text-gray-800 whitespace-pre-wrap">{testCase.preconditions}</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-gray-700">Automation Status:</span>
              <span className={`px-4 py-2 rounded-lg text-sm font-bold
                ${testCase.automation_status === 'Automated' ? 'bg-green-100 text-green-800' : ''}
                ${testCase.automation_status === 'Manual' ? 'bg-gray-200 text-gray-800' : ''}
                ${testCase.automation_status === 'To Be Automated' ? 'bg-blue-100 text-blue-800' : ''}
              `}>
        ...
        {/* Modal Footer */}
        <div className="sticky bottom-0 bg-gray-50 px-8 py-4 border-t border-gray-200 flex items-center justify-between">
