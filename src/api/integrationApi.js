...
export const integrationApi = {
  // Generate scenarios for a project (now accepts swaggerUrl and frdUrl as payload)
  generateScenarios: async (projectId, swaggerUrl, frdUrl) => {
    const response = await apiClient.post('/generate-scenarios', {
