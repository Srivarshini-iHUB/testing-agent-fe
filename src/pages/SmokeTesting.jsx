  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-900 text-gray-900 dark:text-white p-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        {/* View Switch */}
        {/* <div className="mb-4"> */}
          {/* <div className="inline-flex p-1  border-gray-200 dark:border-gray-700/50 rounded-xl shadow-sm"> */}
            {/* <button
              onClick={handleAfterDeploymentClick}
              className={`ml-1 px-4 py-2 rounded-lg font-semibold transition-all ${
                activeTab === 'after'
        ...
        <div className="grid lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white dark:bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-gray-700/50 shadow-lg h-fit">
              <div className="flex items-center gap-2 mb-6">
                <i className="fas fa-cog text-indigo-600 dark:text-indigo-400"></i>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                  {activeTab === 'before' ? 'Test Configuration' : 'Generate Smoke Tests'}
                </h2>
              </div>
          ...
          <div className="space-y-6">
            ...
            {/* Docker Run Summary (After view) */}
            {activeTab === 'after' && report && (
              <div className="bg-white dark:bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-gray-700/50 shadow-lg">
